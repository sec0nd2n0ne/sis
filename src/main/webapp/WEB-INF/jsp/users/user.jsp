...
<head>
    ...
    <title>SIS Web Application</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">${user.lastName}, ${user.firstName}</h1>
                <form:form method="POST">
                    <table>
                        <tr>
                            <td><form:label path="firsName">Firstname</form:label></td>
...
<%--                    <form:label path="lastName">Lastname</form:label> <form:input path = "lastName"/>--%>
<%--                    <form:label path="userProfileID">Profile</form:label> <form:input path = "userProfileID"/>--%>
...
<%--                    <form:label path="mobile">Mobile</form:label> <form:input path = "mobile"/>--%>
<%--                    <form:label path="gender">Gender</form:label> <form:input path = "gender"/>--%>
<%--                    <form:label path="companyID">Company</form:label> <form:input path = "companyID"/>--%>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Ladybug SIS 2019</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
